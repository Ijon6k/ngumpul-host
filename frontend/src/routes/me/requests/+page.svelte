...
<div class="container mx-auto px-6 max-w-5xl py-12 pb-24 flex flex-col gap-8">
	...
	<header class="max-w-2xl">
		<h1 class="font-display font-bold text-3xl text-(--text-main) tracking-tight">Request Project Hosting</h1>
