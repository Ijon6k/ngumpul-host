...
<div class="container mx-auto px-6 max-w-2xl py-12 pb-24 flex flex-col gap-8">
	<div class="flex items-center gap-2 text-xs font-mono text-(--text-muted)">
		<a href="/me" class="hover:text-(--text-main) transition-colors">Personal Space</a>
		<span>/</span>
		<span class="text-(--text-main) font-medium">Settings</span>
	</div>

	<header class="max-w-xl">
		<h1 class="font-display font-bold text-3xl text-(--text-main) tracking-tight">Profile Settings</h1>
