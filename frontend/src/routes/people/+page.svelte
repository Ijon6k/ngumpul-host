...
<div class="container mx-auto px-6 max-w-5xl py-14 pb-24 flex flex-col gap-10">
	<header class="max-w-2xl">
		<h1 class="font-display font-bold text-3xl sm:text-4xl text-(--text-main) tracking-tight mb-2">People</h1>
